...
<ul>
  <li>Deep-dive network traffic analysis between Virtual Machines using Wireshark</li>
  <li>Strategic configuration and deployment of Network Security Groups (NSGs)</li>
  <li>Hands-on experimentation with real-time traffic monitoring and security rule implementation</li>
</ul>
...
<p>
  <img src="https://gdurl.com/9NuO" height="75%" width="100%" alt="Resource Group"/>
</p>
<p>
...
<p>
  <img src="https://gdurl.com/C3Y4" height="75%" width="100%" alt="Windows VM"/>
</p>
<p>
  Create an Ubuntu virtual machine.
</p>
<p>
Select the previously created Resource Group and allow it to create a new Virtual Network (Vnet) and Subnet. Make sure to use the password option under the <strong>Administrator Account</strong> section (not seen in image):
</p>
<p>
  <img src="https://gdurl.com/Abyn" height="75%" width="100%" alt="Ubuntu VM"/>
</p>
<p>
  Observe Your Virtual Network within Network Watcher:
</p>
<p>
  <img src="https://gdurl.com/7waw" height="75%" width="100%" alt="Network Watcher"/>
</p>
<br />
<br />
<h3 align="center">
...
<p>
  <img src="https://gdurl.com/yPvd" height="75%" width="100%" alt="Microsoft Remote Desktop - Mac"/>
</p>
<p>
  Retrieve the private IP address of the Ubuntu VM and attempt to ping it from within the Windows 10 VM. Observe ping requests and replies within WireShark:
</p>
<p>
  <img src="https://gdurl.com/7CRi" height="75%" width="100%" alt="Ubuntu private IP"/>
  <img src="https://gdurl.com/3W21" height="75%" width="100%" alt="ICMP traffic - private IP"/>
</p>
<p>
  Attempt to ping a public website (such as www.google.com) and observe the traffic in WireShark:
</p>
<p>
  <img src="https://gdurl.com/nYIW" height="75%" width="100%" alt="ICMP traffic - public IP"/>
</p>
<p>
  Initiate a perpetual/non-stop ping from your Windows 10 VM to your Ubuntu VM:
</p>
<p>
  <img src="https://gdurl.com/vO_o" height="75%" width="100%" alt="ICMP traffic - perpetual ping"/>
</p>
<p>
  ...
  <img src="https://gdurl.com/bt-k" height="75%" width="100%" alt="ICMP traffic - perpetual ping"/>
  <img src="https://gdurl.com/xiNs" height="75%" width="100%" alt="ICMP traffic - ICMP denied"/>
</p>
<p>
...
<p>
  <img src="https://gdurl.com/6Ny5" height="75%" width="100%" alt="ICMP traffic - ICMP re-enabled"/>
</p>
<br />
<br />
<h3 align="center">
...
<p>
 ...
 <img src="https://gdurl.com/6C6K" height="75%" width="100%" alt="SSH traffic"/>
 <p>
<br />
<br />
<h3 align="center">
...
<p>
  <img src="https://gdurl.com/FKiEJ" height="75%" width="100%" alt="DNS traffic"/>
</p>
<br />
<br />
<h3 align="center">
...
<p>
  <img src="https://gdurl.com/QiXq" height="75%" width="100%" alt="RDP traffic"/>
</p>
<p>
